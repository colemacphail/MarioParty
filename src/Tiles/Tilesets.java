...
public class Tilesets {
    ...
    public static final Tile[] BASIC = new Tile[]{new AddCoinTile(450, 300), new AddCoinTile(400, 300), new AddCoinTile(350, 300), new AddCoinTile(300, 300), new AddCoinTile(250, 300), new StarTile(250, 250), new AddCoinTile(300, 250),  new AddCoinTile(350, 250), };
