...
public class Tilesets {
    ...
    public static final Tile[] WORKING = new Tile[]{new WarpTile(800, 475), new AddCoinTile(750, 475), new AddCoinTile(700, 475),
        new AddCoinTile(650, 475), new ItemTile(600, 475), new SubtractCoinTile(550, 475), new SubtractCoinTile(500, 475), new AddCoinTile(450, 475),
        new AddCoinTile(400, 475), new AddCoinTile(350, 475), new SubtractCoinTile(300, 475), new AddCoinTile(250, 475), new ChanceTimeTile(200, 475),
        new AddCoinTile(150, 475), new SubtractCoinTile(100, 475), new AddCoinTile(100, 400), new SubtractCoinTile(150, 400), new AddCoinTile(200, 400),
        new AddCoinTile(250, 400), new ItemTile(300, 400), new AddCoinTile(350, 400), new SubtractCoinTile(400, 400), new AddCoinTile(450, 400),
        ...
        new SubtractCoinTile(750, 400), new WarpTile(750, 325), new AddCoinTile(700, 325), new SubtractCoinTile(650, 325), new AddCoinTile(600, 325),
        new AddCoinTile(550, 325), new AddCoinTile(500, 325), new PiranhaPlantTile(450, 325), new SubtractCoinTile(400, 325), new AddCoinTile(350, 325),
        ...
        new PiranhaPlantTile(100, 250), new AddCoinTile(150, 250), new AddCoinTile(200, 250), new SubtractCoinTile(250, 250), new AddCoinTile(300, 250),
        new AddCoinTile(350, 250), new SubtractCoinTile(400, 250), new AddCoinTile(450, 250), new AddCoinTile(500, 250), new AddCoinTile(550, 250),
        new SubtractCoinTile(600, 250), new AddCoinTile(650, 250), new ItemTile(700, 250), new SubtractCoinTile(750, 250), new AddCoinTile(750, 175),
        new AddCoinTile(700, 175), new AddCoinTile(650, 175), new SubtractCoinTile(600, 175), new AddCoinTile(600, 100), new SubtractCoinTile(650, 100), new AddCoinTile(700, 100),
